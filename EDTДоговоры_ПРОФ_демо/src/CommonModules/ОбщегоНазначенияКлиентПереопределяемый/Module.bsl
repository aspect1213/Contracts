...
Процедура ПослеНачалаРаботыСистемы() Экспорт
	...
	// Продолжение загрузки после перезапуска.
	...
	Если ПараметрыПодключения.ПродолжитьПослеНачалаРаботыСистемы = Истина
		...
		ОткрытьФорму("Обработка.ЗагрузкаИзБухгалтерииПредприятия.Форма.Форма");
		Возврат;
	...
	Если ПервыйСтарт Тогда
		ОткрытьФорму("Обработка.НачалоРаботы.Форма");
	Иначе
		...
		ОткрытьФорму("Справочник.ДоговорныеДокументы.ФормаСписка", ПараметрыОткрытия);
	КонецЕсли;
