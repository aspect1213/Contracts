...
Процедура ОбновитьСтрокуФайла(Файлы, Файл) Экспорт 
	...
	Для Каждого Строка Из Файлы Цикл
		Если Строка.Ссылка = Файл Тогда 
			СтруктураДанных = ДоговорныеДокументы.ПолучитьДанныеФайлаДляСписка(Файл);
...
Процедура ОбновитьМиникарточку(Форма) Экспорт 
	...
	ДанныеМиникарточки = ДоговорныеДокументы.ПолучитьДанныеМиникарточки(
...
Процедура ВывестиЗаголовкиЗакладок(Форма) Экспорт 
	...
	Если Форма.КоличествоФайлов > 0 Тогда 
		Форма.Элементы.ФайлыНаименование.Заголовок = 
...
Процедура ОтразитьВозвратОригинала(Форма, Документ, ЭтоСписок = Ложь) Экспорт 
	
	ДоговорныеДокументы.ОтразитьВозвратОригинала(Документ);
