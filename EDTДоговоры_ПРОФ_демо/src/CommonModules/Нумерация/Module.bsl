...
Процедура СформироватьЧисловойНомерДокумента(СтруктураПараметров, СформированныйНомер) Экспорт 
	...
	НезависимаяНумерацияПоСвязанномуДокументу = Не (ВидДокумента.Тип = Перечисления.ТипыДоговорныхДокументов.Договор);
	СвязанныйДокумент = Справочники.ДоговорныеДокументы.ПустаяСсылка();
	Если НезависимаяНумерацияПоСвязанномуДокументу Тогда 
		СвязанныйДокумент = СтруктураПараметров.Родитель;
	КонецЕсли;	
	...
	СтруктураИзмерений.Вставить("ВидДокумента", 	  ВидДокумента);
...
Процедура СформироватьСтроковыйНомерДокумента(СтруктураПараметров, СформированныйНомер, ОписанияОшибок) Экспорт 
	...
	ФорматНомера = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ВидДокумента, "ФорматНомера");
