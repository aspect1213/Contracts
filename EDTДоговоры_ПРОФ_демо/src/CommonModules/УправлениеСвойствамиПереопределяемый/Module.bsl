...
Процедура ЗаполнитьНаборыСвойствОбъекта(Объект, ТипСсылки, НаборыСвойств, СтандартнаяОбработка, КлючНазначения) Экспорт
	...
	Если ТипСсылки = Тип("СправочникСсылка.ДоговорныеДокументы") Тогда
		ЗаполнитьНаборыСвойствПоВидуДокумента(Объект.ВидДокумента, НаборыСвойств);
		
	ИначеЕсли ТипСсылки = Тип("СправочникСсылка.Контрагенты") Тогда
		ЗаполнитьНаборыСвойствПоВидуКонтрагента(Объект.ЮридическоеФизическоеЛицо, НаборыСвойств);
