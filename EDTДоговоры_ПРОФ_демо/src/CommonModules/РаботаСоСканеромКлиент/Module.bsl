...
Процедура СканироватьИПоказатьДиалогПросмотра(ВладелецФайла, УникальныйИдентификатор, 
	...
	Если Не ПроинициализироватьКомпоненту() Тогда
		...
		ПараметрыВыполнения = Новый Структура("ВладелецФайла, УникальныйИдентификатор, НеОткрыватьКарточкуПослеСозданияИзФайла",
			ВладелецФайла, УникальныйИдентификатор, НеОткрыватьКарточкуПослеСозданияИзФайла);
