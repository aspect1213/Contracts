	...
	Если ЗначениеЗаполнено(Пользователь) Тогда
		...
		Если ТипЗнч(Пользователь) = Тип("СправочникСсылка.Пользователи") Тогда
			Если ЭтоПолныеПрава Тогда 
				ОткрытьФорму("Справочник.Пользователи.Форма.ФормаЭлементаДляАдминистратора", ПараметрыОткрытия);
			Иначе 
				ОткрытьФорму("Справочник.Пользователи.Форма.ФормаЭлементаДляПользователя", ПараметрыОткрытия);
			КонецЕсли;
