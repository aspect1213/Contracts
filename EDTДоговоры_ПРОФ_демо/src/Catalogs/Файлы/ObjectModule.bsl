...
Процедура ПередЗаписью(Отказ)
	...
	Если Не ЭтоНовый() Тогда
		...
		Если ПометкаУдаления <> ЕстьПометкаУдаленияВИБ Тогда
			// Отбираем правила автозаполнения файлов и пытаемся поставить им пометку удаления
			Запрос = Новый Запрос;
			Запрос.Текст = 
				"ВЫБРАТЬ
				...
				|ГДЕ
				|	ПравилаАвтозаполненияФайлов.ШаблонФайла = &Ссылка";
